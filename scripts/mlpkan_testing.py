...
class KAN_Testing(object):
    ...
    def evaluate(self, rho_id, save_path, prefix):
        ...
        plt.savefig(save_path+'/kan_{}_rho_{}_total_time_{:.4f}_average_loss_{:.4f}_rho_xy_error_{:.4f}\
