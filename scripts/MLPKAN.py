...
class FNO2d(nn.Module):
    def __init__(self, modes1, modes2,  width,n_out,layer_num=4,last_size=128,act_func="silu"):
...
class FNN(nn.Module):
    def __init__(self, layer_sizes, act_func, init_func):
        ...
        # self.kan =  KAN([layer_sizes[0], 128, layer_sizes[-1]])
        self.kan =  KAN([layer_sizes[0], 256, layer_sizes[-1]])

        # self.kan =  KAN([layer_sizes[0], layer_sizes[-1]])            # 2-128
        # self.kan = KAN([layer_sizes[0], 128, 128, layer_sizes[-1]]) # 128x2
...
class deeponet(nn.Module):
    def __init__(self, layer_sizes, act_func, init_func,
                 modes1, modes2, width, n_out=4, layer_num=4,last_size=128,act_fno="silu"):
